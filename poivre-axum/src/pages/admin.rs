...
pub fn Dashboard() -> impl IntoView {
  view! {
    ...
    <AdminTable fetcher=get_all_items caption="Items" />
    <AdminTable fetcher=get_all_users caption="Users"/>
  }
}
...
#[component]
pub fn AdminTable<T,U,E>(fetcher: impl Fn() -> T + 'static, caption: &'static str) -> impl IntoView
where
  E: Debug + 'static,
